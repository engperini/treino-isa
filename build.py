"""Gera a versão em arquivo único (tudo embutido) a partir de src/."""
import base64, json, re
d = ""
h = open(d + "index.html").read()
css = open(d + "app.css").read()
js = "\n".join(open(d + f).read() for f in ["i18n.js", "data.js", "poses.js", "corrida.js", "medidas.js", "contador.js", "app.js"])
...
h = re.sub(r'(<script src="[^"]+"></script>\s*){7}', "<script>\n" + js.replace("\\", "\\\\") + "\n</script>\n", h, count=1)
